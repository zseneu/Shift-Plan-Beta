<?php
class MW_Mcore_Block_Activated extends Mage_Adminhtml_Block_System_Config_Form_Field
{
...
//        ));
        ...
        return '<font style="color:green; font-weight:bold">'.$this->__("Activated").'</font>';// $button->toHtml();
    }
}